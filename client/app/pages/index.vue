    ...
    <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="bg-blue-50 p-6 rounded-lg border border-blue-200">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-3xl font-bold text-blue-600">{{ stats.totalPegawai }}</p>
            </div>
        ...
        <div class="bg-green-50 p-6 rounded-lg border border-green-200">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-gray-600 text-sm">Unit Kerja</p>
              <p class="text-3xl font-bold text-green-600">{{ stats.totalUnit }}</p>
            </div>
        ...
        <div class="bg-purple-50 p-6 rounded-lg border border-purple-200">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-3xl font-bold text-purple-600">{{ stats.totalJabatan }}</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          ...
          <div>
            <p class="font-semibold text-gray-800">Data Pegawai</p>
            <p class="text-sm text-gray-600">Kelola data pegawai</p>
          </div>
        </NuxtLink>
        ...
        >
          ...
          <div>
            ...
            <p class="text-sm text-gray-600">Cetak daftar pegawai</p>
          </div>
        </button>
      </div>
    </div>
...
onMounted(async () => {
  try {
    const api = useApi()
    const [pegawai, units, jabatan] = await Promise.all([
      api.getPegawai({ per_page: 1 }),
      api.getUnitKerja(),
      api.getJabatan()
    ])
    
    stats.value = {
      totalPegawai: pegawai.total || 0,
      totalUnit: units.length || 0,
      totalJabatan: jabatan.length || 0
    }
  } catch (error) {
